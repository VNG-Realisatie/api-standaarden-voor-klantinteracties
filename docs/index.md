...
Een toelichting bij niet-uitgevoerde voornemens bij ontwikkeling van API-specificaties voor Klantinteracties is te vinden onder ['project'](./project.md/#ontwikkeling-gestopt).
